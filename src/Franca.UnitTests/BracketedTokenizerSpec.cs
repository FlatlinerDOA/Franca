...
public class BracketedTokenizerSpec
{
	...
	[TestMethod]
	public void SingleBracketShouldNotMatch() => Assert.IsFalse(AngleBrackets.Parse("<A", (_, __) => _).IsSuccess);

	[TestMethod]
	public void BracketedCharShouldMatch() => Assert.IsTrue(AngleBrackets.Parse("<A>", (_, __) => _).IsSuccess);
